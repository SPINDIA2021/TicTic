...
import com.tiktoknew.activitesfragments.livestreaming.activities.ConcertSelectionA;
import com.tiktoknew.activitesfragments.livestreaming.activities.StreamingMainA;
import com.tiktoknew.activitesfragments.accounts.LoginA;
import com.tiktoknew.activitesfragments.accounts.ManageAccountsF;
import com.tiktoknew.activitesfragments.profile.privatevideos.PrivateVideoF;
...
import com.tiktoknew.simpleclasses.CircleDivisionView;
...
import com.tiktoknew.activitesfragments.profile.likedvideos.LikedVideoF;
...
public class ProfileTabF extends Fragment {
    ...
    private View init() {
        view.findViewById(R.id.live_btn).setOnClickListener(new DebounceClickHandler(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
