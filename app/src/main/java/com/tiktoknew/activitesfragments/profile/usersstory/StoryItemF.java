package com.tiktoknew.activitesfragments.profile.usersstory;
...
import com.tiktoknew.databinding.FragmentStoryItemBinding;
...
import com.tiktoknew.simpleclasses.CountDownTimerPausable;
import com.tiktoknew.simpleclasses.DebounceClickHandler;
import com.tiktoknew.simpleclasses.Functions;
import com.tiktoknew.simpleclasses.OnStoryTouchListener;
...
public class StoryItemF extends Fragment implements Player.Listener{
    ...
    private void openStoryEmoticons() {
        performStopAction();
        StoryEmoticonF fragment = new StoryEmoticonF(new FragmentCallBack() {
            @Override
    ...
    public void sendStoryLike(StoryModel selectedStory, StoryVideoModel storyModel,String emojiCode) {
        Functions.showLoader(bindingRef.getRoot().getContext(),false,false);
    ...
    private void showStoryPlayer() {
        performStopAction();
        initExoPlayer(selectedStoryItem.getVideoList().get(currentIndex).getVideo());
    }
