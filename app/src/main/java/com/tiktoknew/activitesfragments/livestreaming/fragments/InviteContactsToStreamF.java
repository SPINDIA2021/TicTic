...
import com.tiktoknew.activitesfragments.livestreaming.adapter.Contacts_Adapter;
import com.tiktoknew.activitesfragments.livestreaming.model.ContactsDataModel;
import com.tiktoknew.activitesfragments.livestreaming.model.Group_member_GetSet;
import com.tiktoknew.adapters.ProfileSharingAdapter;
...
import com.tiktoknew.models.ShareAppModel;
...
public class InviteContactsToStreamF extends BottomSheetDialogFragment {
    ...
    public void getOwnSharedApp() {
        ...
        recylerviewShareToSocial.setHasFixedSize(false);
