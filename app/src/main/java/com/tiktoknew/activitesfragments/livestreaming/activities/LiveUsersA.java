...
import com.tiktoknew.activitesfragments.livestreaming.adapter.LiveUserAdapter;
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                if (dataSnapshot.exists())
                {
                    ...
                    if (model.getUserId()!=null && !(TextUtils.isEmpty(model.getUserId())) && !(model.getUserId().equals("null")))
                    {
                        ...
                        {
                            Log.d(com.tiktoknew.Constants.tag,"Removing Key Id: "+dataSnapshot.getKey());
                            removeStreamingHead(""+dataSnapshot.getKey());
                        }
                    }
                    else
                    {
                        Log.d(com.tiktoknew.Constants.tag,"Removing Key: "+dataSnapshot.getKey());
                        removeStreamingHead(""+dataSnapshot.getKey());
                    }
                }
            }
    ...
    private void removeStreamingHead(String key) {
        ...
        rootref.child("LiveUsers").child(key).removeValue(new DatabaseReference.CompletionListener() {
            ...
            public void onComplete(@Nullable DatabaseError error, @NonNull DatabaseReference ref) {
                Log.d(com.tiktoknew.Constants.tag,"Remove: "+error);
            }
        });
    }
