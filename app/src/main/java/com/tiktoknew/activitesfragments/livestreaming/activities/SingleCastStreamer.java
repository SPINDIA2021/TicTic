package com.tiktoknew.activitesfragments.livestreaming.activities;
...
import com.tiktoknew.activitesfragments.EditTextSheetF;
import com.tiktoknew.activitesfragments.livestreaming.adapter.LiveCommentsAdapter;
import com.tiktoknew.activitesfragments.livestreaming.adapter.LiveUserViewAdapter;
import com.tiktoknew.activitesfragments.livestreaming.fragments.InviteContactsToStreamF;
import com.tiktoknew.activitesfragments.livestreaming.model.CameraRequestModel;
import com.tiktoknew.activitesfragments.livestreaming.model.LiveCoinsModel;
import com.tiktoknew.activitesfragments.livestreaming.model.LiveCommentModel;
import com.tiktoknew.activitesfragments.livestreaming.model.LiveUserModel;
import com.tiktoknew.activitesfragments.livestreaming.stats.LocalStatsData;
import com.tiktoknew.activitesfragments.livestreaming.stats.RemoteStatsData;
import com.tiktoknew.activitesfragments.livestreaming.stats.StatsData;
import com.tiktoknew.activitesfragments.livestreaming.ui.VideoGridContainer;
import com.tiktoknew.activitesfragments.sendgift.StickerModel;
...
import com.tiktoknew.models.StreamShowHeartModel;
import com.tiktoknew.R;
import com.tiktoknew.models.UsersModel;
import com.tiktoknew.simpleclasses.Functions;
import com.tiktoknew.simpleclasses.OnSwipeTouchListener;
import com.tiktoknew.simpleclasses.Variables;
import com.tiktoknew.simpleclasses.streaminglikes.HeartView;
...
public class SingleCastStreamer extends RtcBaseActivity implements View.OnClickListener {
    ...
    private void ActionControl() {
        ...
        tabMainView.setOnTouchListener(new OnSwipeTouchListener(context) {
            ...
            public void onSwipeRight() {
                ...
                Log.d(com.tiktoknew.Constants.tag,"start");
            ...
            public void onSwipeLeft() {
                ...
                Log.d(com.tiktoknew.Constants.tag,"end");
                if (viewTwo==viewflliper.getCurrentView())
                {
            ...
            joinValueEventListener = new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    if (dataSnapshot.exists())
                    {
                        ...
                        {
                            Log.d(com.tiktoknew.Constants.tag,"Data JSON : "+joinSnapsot.getValue().toString());
        ...
        if (connectCheckListener==null)
        {
            ...
            connectCheckListener=new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    if (connected) {
                        Log.d(com.tiktoknew.Constants.tag, "connected");
                        timer.cancel();
                    } else {
                        Log.d(com.tiktoknew.Constants.tag, "not connected");
                        timer.cancel();
                        timer = new Timer();
                        timer.schedule(
                                new TimerTask() {
                ...
                @Override
                public void onCancelled(@NonNull DatabaseError error) {
                    Log.w(com.tiktoknew.Constants.tag, "Listener was cancelled");
                }
            };
    ...
    private void initUI() {
        ...
        rtcEngine().setBeautyEffectOptions(isbeautyActivated,
                com.tiktoknew.activitesfragments.livestreaming.Constants.DEFAULT_BEAUTY_OPTIONS);
    ...
    private void initData() {
        Functions.printLog(com.tiktoknew.Constants.tag, "initData");
        mVideoDimension = com.tiktoknew.activitesfragments.livestreaming.Constants.VIDEO_DIMENSIONS[
    ...
    public void onFirstRemoteVideoDecoded(final int uid, int width, int height, int elapsed) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Functions.printLog(com.tiktoknew.Constants.tag, "onFirstRemoteVideoDecoded");
    ...
    private void renderRemoteUser(int uid) {
        Functions.printLog(com.tiktoknew.Constants.tag, "renderRemoteUser");
    ...
    public void onRemoteAudioStats(IRtcEngineEventHandler.RemoteAudioStats stats) {
        Functions.printLog(com.tiktoknew.Constants.tag, "onRemoteAudioStats");
        if (!statsManager().isEnabled()) return;
