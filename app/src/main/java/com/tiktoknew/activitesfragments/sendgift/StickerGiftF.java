package com.tiktoknew.activitesfragments.sendgift;
            ...
            public void onResponce(String resp) {
                ...
                if (resp!=null){
                    ...
                    try {
                        ...
                        {
                            Functions.showAlert(getActivity().getApplicationContext(), getActivity().getApplicationContext().getString(R.string.server_error), jsonObject.optString("msg","Our technical team work on this issue"));
        ...
        VolleyRequest.JsonPostRequest(getActivity(), ApiLinks.sendGift, params,Functions.getHeaders(getActivity()), new Callback() {
            ...
            public void onResponce(String resp) {
                ...
                try {
                    ...
                    {
                        Functions.showAlert(getActivity().getApplicationContext(),getActivity().getApplicationContext().getString(R.string.server_error),""+jsonObject.optString("msg"));
                    }
                    else
