    ...
    public void setupVideoProgress() {
        ...
        videoProgress.SetListener(new ProgressBarListener() {
            ...
            public void timeinMill(long mills) {
                Log.d(Constants.tag,"timeinMill123: "+mills);
                timeInMilis = mills;
...
//        progress synced with two filter
    ...
    public void applySpeedWithHFlipFunctionality(){
        ...
        Functions.showDeterminentLoader(context,false,false,true,context.getString(R.string.rendering_));
        FFMPEGFunctions.INSTANCE.videoHorizentalFlipProcess(VideoRecoderDuetA.this,intputPath,frameRate
                ,Functions.getSharedPreference(context).getString(Variables.COMMPRESSION_VALUE,"2000")
                , new FragmentCallBack() {
                    @Override
                    public void onResponce(Bundle bundle) {
    ...
    public void changeFlipedVideo(String srcMp4Path, final String destMp4Path) {
        ...
        Functions.showDeterminentLoader(this, false, false,true,VideoRecoderDuetA.this.getString(R.string.rendering_));
