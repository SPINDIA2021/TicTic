...
import com.tiktoknew.trimmodule.CustomProgressView;
import com.tiktoknew.trimmodule.FileUtils;
import com.tiktoknew.trimmodule.TrimVideo;
import com.tiktoknew.trimmodule.TrimVideoOptions;
    ...
    private void trimVideo() {
        if (isValidVideo) {
            ...
            if (allowRecordingDuration<=allowDuration)
            {
                ...
                String frameRate=Functions.getTrimVideoFrameRate(new File(""+uri).getAbsolutePath());
                ...
                FFMPEGFunctions.INSTANCE.trimVideoProcess(new File(""+uri),
                        ...
                        , Functions.getTimeWithAdditionalSecond("HH:mm:ss", (int) lastMaxValue),frameRate
                        ,Functions.getSharedPreference(ActVideoTrimmer.this).getString(Variables.COMMPRESSION_VALUE,"2000")
