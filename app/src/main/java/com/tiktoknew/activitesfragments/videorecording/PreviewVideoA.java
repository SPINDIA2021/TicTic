...
import com.tiktoknew.simpleclasses.FilterType;
import com.tiktoknew.adapters.FilterAdapter;
...
public class PreviewVideoA extends AppCompatLocaleActivity implements Player.Listener {
    ...
    public void saveVideo(String srcMp4Path, final String destMp4Path) {
        ...
        Functions.showDeterminentLoader(this, false, false,true,PreviewVideoA.this.getString(R.string.rendering_));
