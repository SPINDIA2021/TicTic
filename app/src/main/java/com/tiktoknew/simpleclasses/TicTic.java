...
import com.tiktoknew.activitesfragments.CustomErrorActivity;
import com.tiktoknew.activitesfragments.livestreaming.Constants;
import com.tiktoknew.activitesfragments.livestreaming.rtc.AgoraEventHandler;
import com.tiktoknew.activitesfragments.livestreaming.rtc.EngineConfig;
import com.tiktoknew.activitesfragments.livestreaming.rtc.EventHandler;
import com.tiktoknew.activitesfragments.livestreaming.stats.StatsManager;
import com.tiktoknew.activitesfragments.livestreaming.utils.FileUtil;
import com.tiktoknew.activitesfragments.livestreaming.utils.PrefManager;
...
import static com.tiktoknew.simpleclasses.ImagePipelineConfigUtils.getDefaultImagePipelineConfig;
...
public class TicTic extends Application implements Application.ActivityLifecycleCallbacks, BackgroundDetectorHandler.OnVisibilityChangedListener {
        ...
        if (Functions.getSharedPreference(getApplicationContext()).getBoolean(Variables.IS_LOGIN,false))
        {
            rootref.child(Variables.onlineUser).child(Functions.getSharedPreference(getApplicationContext()).getString(Variables.U_ID,"0"))
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    Log.d(com.tiktoknew.Constants.tag,"removeOnlineStatus: "+Functions.getSharedPreference(getApplicationContext()).getString(Variables.U_ID,"0"));
                };
            });
        ...
        if (Functions.getSharedPreference(getApplicationContext()).getBoolean(Variables.IS_LOGIN,false))
        {
            ...
            rootref.child(Variables.onlineUser).child(Functions.getSharedPreference(getApplicationContext()).getString(Variables.U_ID,"0")).setValue(onlineModel)
                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
                        public void onComplete(@NonNull Task<Void> task) {
                            Log.d(com.tiktoknew.Constants.tag,"addOnlineStatus: "+onlineModel.getUserId());
                        };
                    });
        ...
        FirebaseMessaging.getInstance().getToken()
                .addOnCompleteListener(new OnCompleteListener<String>() {
                    ...
                    public void onComplete(@NonNull Task<String> task) {
                        ...
                        Log.d(com.tiktoknew.Constants.tag,"token: "+token);
    ...
    {
        Log.d(com.tiktoknew.Constants.tag,"onAppGoesToBackground");
        removeOnlineListener();
    }
    ...
    {
        Log.d(com.tiktoknew.Constants.tag,"onAppGoesToForeground");
        addOnlineListener();
    }
